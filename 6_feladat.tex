...
\begin{figure}[H]
	...
	\begin{subfigure}[H]{\textwidth}
		\centering
		\incfig[.8\textwidth]{6a_allapotter_hatasvazlat}
		\caption{Alapjelkompenzációval}
		\label{fig:6a_allapotter_hatasvazlat}
	\end{subfigure}
	\begin{subfigure}[H]{\textwidth}
		\centering
		\incfig[.7\textwidth]{6a_allapotter_hatasvazlat_stripped}
...
% A pozíció-szabályzott rendszer átviteli függvénye $\fn{W}_\text{p}$ integrálja, vagyis
% \begin{equation}
%     \fn{W}_\text{p,új} = \frac{\Psi}{s(1+T_1s)(1+T_2s)} =
%     \frac{\frac{\Psi}{T_1T_2}}{s^3+\frac{T_1+T_2}{T_1T_2}s^2+\frac{1}{T_1T_2}s}.
% \end{equation}
