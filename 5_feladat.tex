...
%
Tehát \fbox{$a_0 = 400$ és $a_1 = 23,65$}, ebből a pólusok
\begin{align}
...
A végérték-tétel alapján az állandósult szögsebesség $\omega_\infty = \lim\limits_{s\rightarrow 0}s\fn{Y} = 1,3145\cdot10^7$.%TODO
